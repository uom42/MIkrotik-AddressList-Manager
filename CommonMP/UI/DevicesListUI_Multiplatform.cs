...
partial class DevicesListUI
{
	...
	private async Task SaveDevicesList()
	{
		...
		//uom.controls.ListViewItemT<DevicesListRecord>? SelectedDeviceeeeee		=> lvwDevices.e_SelectedItemsAs<uom.controls.ListViewItemT<DevicesListRecord>>().FirstOrDefault();


		var rows = lvwDevices
			.e_ItemsAs<uom.controls.ListViewItemT<DevicesListRecord>>()
			.Select(li => li.Value2);
#endif
