...
namespace MALM.OUI
{
	...
	internal class MacRecordsGroup
	{
		...
		public MacRecordsGroup(string mFGCode, MacRecordInfo[] infoList)
		{
			...
			InfoList.e_ForEach(il => il.Parent = this);
		}

		public string? MfgCountryID => InfoList.FirstOrDefault(r => r.Country2LetterUCode.e_IsNotNullOrWhiteSpace())?.Country2LetterUCode;
