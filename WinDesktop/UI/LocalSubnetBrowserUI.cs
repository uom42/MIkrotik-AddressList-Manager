...
namespace MALM.UI
{
    public partial class LocalSubnetBrowserUI : Form
    {
        ...
        private async Task OnLoad ()
        {
            ...
            lvwRows.clearItems();
#if WINDOWS
            lvwRows.GroupCollapsedStateChanged += ( _ , _ ) => lvwRows.SaveGroupsState(dataID: "ARP_List");
		...
		//await RefreshList();
            ...
            //{
            lvwRows.RestoreGroupsStateFromStorage(dataID: "ARP_List");
            lvwRows.addItems(rows , true);
            //});
            //OnDeviceSelected();
