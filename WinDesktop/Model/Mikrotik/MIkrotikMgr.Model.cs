...
namespace Mikrotik.API
{
	...
	public static class Extensions
	{
		...
		private static Lazy<AddressListItemComparer> _addressListItemComparer = new(new AddressListItemComparer());

		[DebuggerNonUserCode, DebuggerStepThrough, MethodImpl(MethodImplOptions.AggressiveInlining)]
		internal static IEnumerable<AddressListItem> e_SortAddressList(this IEnumerable<AddressListItem> src) => src
			.OrderBy(r => r.List)
			.ThenBy(r => r.Address, _addressListItemComparer.Value);
	}
	...
	namespace Model
	{
		...
		public class ItemBase
		{
			...
			internal bool Enabled { get => !Disabled; set => Disabled = !value; }
